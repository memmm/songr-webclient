...
export const spotifyWebApiURL = `https://accounts.spotify.com/authorize/?client_id=${clientID}&response_type=code&redirect_uri=${redirectURI}&scope=${scopes}&show_dialog=false`;
...
export const songrService = "http://localhost:8080/com_songr_services_contract_war_exploded/";
